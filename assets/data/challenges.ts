...
export const CHALLENGES: MapChallenge[] = [
  ...
  },
  {
    ...
    image: TowerImage,
    quest: 'Sukurti dar vieną mozaiką iš pekelėje pasitaikiusių akmenėlių (papildomi taškai už Vilnelės globotinius)',
  },
  {
    id: 'c3',
  ...
  {
    id: 'c6',
    title: 'Geriausia Darbo Pietų Pertrauka',
